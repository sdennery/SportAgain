    ...
    <body id="body">
        <div id="fondBleu">
        <article id="corps">
            <form action="../Controleur/formulaire.php" method="POST" enctype="multipart/form-data">
                <p> <b style="font-size:22px;margin-left:18%">Information sur votre club </b>  <br></p>
                <br>
                <p>Nom du club :</p>
                <p id="NomClub">
                    <input type="text" name="Nom_du_club" required/>
                ...
                <p> Adresse du club :</p>
                <p id="AdresseClub">
                    <input type="text" name="Adresse_du_club" required/>
                </p>
                <p>Département :</p>
                <p id="Departement">
                    <select name="choixDepart" style="width:173px;" required>
                ...
                <p id="numAssociation">          <input type="text" name="Numero_association" required/>
                </p>
                <p>Téléphone du club :</p>
                <p id="telephoneClub">
                    <input type="text" name="Telephone_du_club" required/>
                </p>
                <p>Sport(s) pratiqué(s) :</p>
                <p id="sportPratique">
                    <select name="Sport" style="width:173px" required>
                ...
                <p>Description :</p>
                <p id="Description">
                    <textarea name='Descriptif' style="padding-right:12px; height:100px" required></textarea>
                </p>
                <p><input type="file" name="image" style="margin-left:160px" required/></p>
                <br>
                 <input type="submit" value="Valider" style="margin-left:180px" required/>
                  </form>
    </article>
    </div>
