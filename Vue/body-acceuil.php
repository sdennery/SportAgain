		...
		<section id="info">
                    ...
                    <div class="a2">
                        <center><h2 class="a2_titre">GROUPES</h2></center>
                                <?php include '../Modele/afficher_groupe_recent.php'?>                
			</div>
			<div class="a2">
                            
				 <center><h2 class="a2_titre">CLUBS</h2></center>
                                <?php include '../Modele/afficher_club_recent.php'?> 
                                
			</div>
                    <div class="a2">
				 <center><h2 class="a2_titre">EVENEMENTS</h2></center>
                                <?php include '../Modele/afficher_evenement_recent.php'?> 
			</div>
                    <div class="a2">
				 <center><h2 class="a2_titre">UTILISATEURS</h2></center>
                                <?php include '../Modele/afficher_utilisateur_recent.php'?> 
                                <br/>
                                <br/>
                                <br/>
                                <br/>
