    ...
    <link rel="stylesheet" href="../Vue/header.css">
        ...
        <header> 
            ...
            <div id="header">
                ...
                <div id="teteD"> <a href="../Vue/vue_gestion_profil.php"class="design2"><?php echo  $_SESSION['pseudo'] ; ?> </a>  <span> | </span> <a class="design2" href="../Vue/controleur_deconnexion.php"> Déconnexion </a> </div>
            </div> 
            <div id="gris">     
                <nav id="menu">    
                <ul>
