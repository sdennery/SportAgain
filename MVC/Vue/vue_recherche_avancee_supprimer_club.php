                    ...
                    {        
                        ...
                        ?>
                            ...
                            <aside id="position_nom">
                                <span><?php echo "<a href=\"#\" onClick=\"confirme71('".$vignettes_club['id_club']."','".$vignettes_club['Departement']."','".$vignettes_club['sport']."')\" >";?><?php echo $vignettes_club['nom']?><?php echo "</a>";?></span>
                            </aside>
                            <aside id="position_sup">
                                <span><?php echo "<a href=\"#\" onClick=\"confirme7('".$vignettes_club['id_club']."','".$vignettes_club['Departement']."','".$vignettes_club['sport']."')\" >";?><img src="../Vue/Image/button-supprimer(2).png" /><?php echo "</a>";?></span>
                            </aside>
                            <br>
                        <?php
                        }
