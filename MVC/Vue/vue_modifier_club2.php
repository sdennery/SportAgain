...
<html>
    <head>
        <link rel="stylesheet" href="../Vue/Page_club.css">
        <meta charset="utf-8"/>
    </head>
    ...
    while ($donnees = $reponse->fetch())
{
 ?>        
    <body id="body">
        <div id="fondBleu">
        <article id="corps">
            <form action="../Controleur/controleur_modifier_back-office_club.php" method="POST" enctype="multipart/form-data">
                ...
                <p>ID club :</p>
                <p>
                    <select name="id_club" style="margin-top:-35px;margin-left:170px;">
