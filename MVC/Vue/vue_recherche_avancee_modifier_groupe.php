        ...
        <div id="gestion">
                    ...
                    if($nombre_total_vignette!=0)
                    {
                        ...
                        ?>
                            ...
                            <aside id="position_nom">
                                <span><?php echo "<a href=\"#\" onClick=\"groupe_recherche_avancee('".$vignettes_groupe['id_groupe']."','".$vignettes_groupe['sport']."','".$vignettes_groupe['niveau']."','".$vignettes_groupe['etat']."','".$vignettes_groupe['departement']."')\" >";?><?php echo $vignettes_groupe['nom']?><?php echo "</a>";?></span>
                            </aside>
                            <aside id="position_sup">
                                 <span><?php echo "<a href=\"#\" onClick=\"groupe_recherche_avancee_modifier('".$vignettes_groupe['id_groupe']."','".$vignettes_groupe['departement']."','".$vignettes_groupe['sport']."','".$vignettes_groupe['niveau']."','".$vignettes_groupe['etat']."')\" >";?>Modifier<?php echo "</a>";?></span>
                            </aside>
                            <br>
                        <?php
                        }
            ...
            {      
                if(isset($nombre_total_modifier_vignette))
                {
                    ...
                    {        
                        foreach($vignettes_modifier_groupe as $vignettes_modifier_groupe)
                        {
                        ?>
                            <article>
                                <span id="position_photo"><img src="../Vue/Image/facebook.png" id="taille"/></span>
                            ...
                            <aside id="position_nom">
                                <span><?php echo "<a href=\"#\" onClick=\"groupe_recherche_avancee('".$vignettes_modifier_groupe['id_groupe']."','".$vignettes_modifier_groupe['departement']."','".$vignettes_modifier_groupe['sport']."','".$vignettes_modifier_groupe['niveau']."','".$vignettes_modifier_groupe['etat']."')\" >";?><?php echo $vignettes_modifier_groupe['nom']?><?php echo "</a>";?></span>
                            </aside>
                            <aside id="position_sup">
                                <span><?php echo "<a href=\"#\" onClick=\"groupe_recherche_avancee_modifier('".$vignettes_modifier_groupe['id_groupe']."','".$vignettes_modifier_groupe['departement']."','".$vignettes_modifier_groupe['sport']."','".$vignettes_modifier_groupe['niveau']."','".$vignettes_modifier_groupe['etat']."')\" >";?>Modifier<?php echo "</a>";?></span>
                            </aside>
                            <br>
                        <?php
                        }
