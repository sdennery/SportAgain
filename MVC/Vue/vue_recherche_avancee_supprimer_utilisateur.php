                    ...
                    if($nombre_total_vignette!=0)
                    {
                        ...
                        ?>
                            ...
                            <aside id="position_nom">
                                <span><?php echo "<a href=\"#\" onClick=\"confirme91('".$vignettesutilisateur['id_utilisateur']."','".$vignettesutilisateur['departement']."','".$vignettesutilisateur['sport_favori']."')\" >";?><?php echo $vignettesutilisateur['nom_utilisateur']?><?php echo "</a>";?></span>
                            </aside>
                            <aside id="position_sup">
                                <span><?php echo "<a href=\"#\" onClick=\"confirme9('".$vignettesutilisateur['id_utilisateur']."','".$vignettesutilisateur['sport_favori']."','".$vignettesutilisateur['departement']."')\" >";?><img src="../Vue/Image/button-supprimer(2).png" /><?php echo "</a>";?></span>
                            </aside>
                        <?php
                        }
                    }else{
