...
<body>
    <div style="background-color: white;margin-top: -29px;border-radius: 3px;">
        <br>
        <br>
          <div class="bordure">
    ...
    ?>
        <table id ="vignette">
                    <tr style="margin-left:25px;">
                        <td> <img src="../Vue/Image/<?php $donnees['photo']?>" class="alignement" id="alignement_image" style="height: 150px;width: 200px"/> <p style="margin-left: 15px">Propriétaire : <?php echo $donnees['Nom_proprietaire']?></p> <p style="margin-left: 15px"><?php echo "Tél : 0"?><?php echo $donnees['telephone']?></p></td>
                        <td></td>
