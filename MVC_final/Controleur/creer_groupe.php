...
<html>
    <head>
        ...
        <div style=" background-color:white;margin-top: -29px;">
            <br> </br>
            <div style="background-position:bottom;border:solid 2.5px black; height: 300px; width:1000px;margin:auto; background-image: url('../Vue/Images/changer-fond-ecran-windows_01.jpg');border-radius:5px">
