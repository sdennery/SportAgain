        ...
        try
{
    ...
    $reponse = $bdd->query('SELECT * FROM club WHERE id_club=26');
    ...
    while ($donnees = $reponse->fetch())
{
 ?>
    ...
    <body id="body">
        <div id="fondBleu">
        <article id="corps">
            <form action="../Controleur/controleur_modification_club.php" method="post" enctype="multipart/form-data">
                ...
                <p id="numAssociation"> <input type="text" name="Numero_association" value="<?php echo $donnees['numero_club'];?>" required=""/>
                </p>
                <p>Téléphone du club :</p>
                <p id="telephoneClub">
                    <input type="text" name="telephone_du_club" value="<?php echo $donnees['telephone'];?>"/>
                </p>
