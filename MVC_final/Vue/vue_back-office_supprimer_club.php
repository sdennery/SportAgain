    ...
    <div id="gestion">
        ...
        if (isset($_GET['requete']))
        {
            if(isset($vignettes))
            {
                ...
                ?>
                    <article>
                        <span id="position_photo"><img src="../Vue/Image/<?php echo $vignette['photo']?>" id="taille"/></span>
                    </article>
        ...
        if(isset($vignettesclub))
        {
            if(!empty($vignettesclub))
            {
                ...
                ?>
                    <article>
                        <span id="position_photo"><img src="../Vue/Image/<?php echo $vignettesclub['photo']?>" id="taille"/></span>
                    </article>
                    <aside id="position_nom">
