...
<html>
    ...
    $reponse = $bdd->query('SELECT * FROM club WHERE id_club='.$id);
    while ($donnees = $reponse->fetch())
{
 ?>        
    <body id="body">
        <div id="fondBleu">
        <article id="corps">
            <form action="../Controleur/controleur_modifier_recherche_back-office_club.php" method="GET" enctype="multipart/form-data">
                <p> <b style="font-size:22px;margin-left:18%">Informations de votre club </b>  <br></p>
                <br>
                <p>Elément de la recherche : 
                    <select name ="requete" style="margin-left:5px;">
                        <option value="<?php echo $_GET['requete']?>" selected><?php echo $_GET['requete']?></option>
                    </select>
                </p>
                <p>Nom du club :</p>
                <p id="NomClub">
                ...
                <p> Adresse du club :</p>
                <p id="AdresseClub">
                    <input type="text" name="adresse" value="<?php echo $donnees['adresse'];?>" required=""/>
                </p>
                <p>Département :</p>
                <p id="Departement">
                    <select name="departement" style="width:173px;">
                ...
                <p id="numAssociation"> <input type="text" name="numero_club" value="<?php echo $donnees['numero_club'];?>" required=""/>
                </p>
                ...
                <p>Description :</p>
                <p id="Description">
                    <textarea name='descriptif' style="padding-right:12px; height:100px" required=""> <?php echo $donnees['descriptif'];?></textarea>
                </p>
                <p>ID club :
                <span style="margin-left:109px;">
                    <select name="id_club">
                           <option value="<?php echo $donnees['id_club']?>" selected><?php echo $donnees['id_club']?></option>
                    </select>
                </span>
                </p>
                <br>
