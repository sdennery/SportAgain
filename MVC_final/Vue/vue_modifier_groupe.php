        ...
        try
{
    ...
    $reponse = $bdd->query('SELECT * FROM groupe WHERE id_groupe=19');
    ...
    <body>
        ...
        <div class="fondBleu">
            ...
            <div class="bordure">
                ...
                <form method="post" action="../Controleur/controleur_modification_du_groupe.php">
                    <p> Type de groupe : <select class="placement" name="type" > 
                    ...
                    <p> Niveau :  <select name="niveau" size="1" style="width:153px;height:25px" class="espace">  <option value="debutant"> Débutant </option> 
                            ...
                            <option value="confirme"> Confirmé </option></select> </select></p>
