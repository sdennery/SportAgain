<html>
    <head>
        <meta charset="utf-8"/>
        <link rel="stylesheet" href="rechercheclub2.css">
    </head>
     <?php 
    ...
    <body>
        ...
        <div class="fondBleu">
            <br> </br>
            <div class="bordure">
                <p style="font-size:18px;margin-left:410px"> <strong> Recherche avancée d'un club </strong> </p>
                <br>
                <form method="post" action="form_rech_club.php">
                        ...
                        <p style="font-size: 20px;color: red;"> <b>* Veuillez saisir tous les champs</b></p>
        </form>
        <br>
        </div>    
        <br>
