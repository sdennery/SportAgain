	...
	<div id="menu_sport">
			<ul id="menude">
				<li><a href="#">Sport de raquette</a>
					<ul>
						<li class="separation"><img class="image_sport" src="../Vue/Images/tennis-ball.png"><span class="gauche"></span><a href="#">Tennis</a><span class="droite"></span><img class="image_sport" src="../Vue/Images/ping-pong.png"><a href="#">Tennis de table</a></span></li>
