    ...
    <link rel="stylesheet" href="../Vue/header.css">
        ...
        <header> 
            ...
            <div id="header">
                ...
                <div id="teteD"> <a href="../Controleur/controleur_back-office.php"class="design2"><?php echo  $_SESSION['pseudo'] ; ?> </a>  <span> | </span> <a class="design2" href="../Vue/controleur_deconnexion.php"> Déconnexion </a> </div>
            </div> 
            <div id="gris">     
                <nav id="menu">    
                <ul>
					...
					<li>
						...
						<ul>
							...
							<li><a href="#" style="width:235px"> Ajout d'un sport</a></li>
                	...
                	<li>
                    	<a href="../Controleur/Controleur_Forum.php">Forum</a>
                	</li>
                	<li>
                    	<a href="#">Aide</a>
                    	<ul>
